...
public class NpcMision extends Element {
	...
	private void interactuar() {
	    ...
	    if(Parametros.mision_un_extrano_muneco == true && inProgress == false) {
	    ...
	    else if(Parametros.mision_un_extrano_muneco == true && inProgress == true) {
		    switch (siguienteInteraccion) {
	        case 0:
	            AudioManager.playSound("01-FS/Audio/sounds/menuBoton.wav");
	    ...
	    else if (Parametros.mision_un_extrano_muneco == false && inProgress == true) {
		    switch (siguienteInteraccion) {
	        case 0:
	            AudioManager.playSound("01-FS/Audio/sounds/menuBoton.wav");
	    ...
	    else if (Parametros.mision_un_extrano_muneco == false && finished == true) {
		    switch (siguienteInteraccion) {
	        case 0:
	            AudioManager.playSound("01-FS/Audio/sounds/menuBoton.wav");
