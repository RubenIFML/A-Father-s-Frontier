...
/**
 * Establece la persona 3 del día 2 de la Frontera.
 * @author Rubén Moya
 */
public class FS2_3 extends Actor {
    ...
    public FS2_3(Stage mainStage) {
        ...
        persona7 = ResourceManager.getTexture("01-FS/Personajes/FS.2_3.png");
    }
    ...
    public void act(float delta) {
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.ENTER) && Parametros.controlesActivos==true && Parametros.analizar==true) {
        	...
        	texto = new Texto("Mario: ¿Es una broma\n"
        					+ "¡No saldrás de esta!", 7, 154, "talk1");
        	mainStage.addActor(texto);
     ...
     */
    public void hide() {
    	this.persona7 = ResourceManager.getTexture("01-FS/Personajes/transparente.png");
    }
